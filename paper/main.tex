...
A transformer trained on $P$ transfers to $Q$ no better than an
untrained network -- yet the transplant control recovers its original
performance exactly. Reasoning, in that narrow sense, is abstract;
recognizing that a new instance calls for it is not.
